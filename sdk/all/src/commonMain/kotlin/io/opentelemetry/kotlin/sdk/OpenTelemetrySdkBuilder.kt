...
internal constructor() {
    ...
    /**
     * Sets the [SdkTracerProvider] to useAndClose. This can be used to configure tracing settings by
     * returning the instance created by a [SdkTracerProviderBuilder].
     *
     * If you useAndClose this method, it is assumed that you are providing a fully configured
     ...
     *
     * @param tracerProvider A [SdkTracerProvider] to useAndClose with this instance.
    ...
    /** Sets the [ContextPropagators] to useAndClose. */
     ...
     * times in the lifecycle of an application - ensure you have only one SDK for useAndClose as the global
     * instance. If you need to configure multiple SDKs for tests, useAndClose [ ]
     ...
     * [OpenTelemetrySdkBuilder.buildAndRegisterGlobal] for useAndClose by instrumentation that requires
