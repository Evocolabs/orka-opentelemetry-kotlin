...
/**
 * A value that can be stored inside [Context]. Types will generally useAndClose this interface to allow
...
interface ImplicitContextKeyed {
     ...
     * [ThreadLocal]. Kotlin coroutine users SHOULD NOT useAndClose this method as the [ ] will not be
     * properly synced across coroutine suspension and resumption. Instead, useAndClose
